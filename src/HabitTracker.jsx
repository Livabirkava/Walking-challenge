...
// Helper: shorten "Līva Birkava" -> "Līva B."
          ...
          <div className="grid grid-cols-3 gap-6">
            ...
            <div>
              ...
              <div className="grid grid-cols-7 gap-1 text-center text-xs">
                ...
                <div className="bg-sky-300 text-white py-1 rounded">26</div>
            ...
            <div>
              ...
              <div className="grid grid-cols-7 gap-1 text-center text-xs">
                ...
                <div className="bg-sky-300 text-white py-1 rounded">1</div>
                <div className="bg-sky-300 text-white py-1 rounded">2</div>
                ...
                <div className="bg-blue-500 text-white py-1 rounded">10</div>
                <div className="bg-blue-500 text-white py-1 rounded">11</div>
                <div className="bg-blue-500 text-white py-1 rounded">12</div>
                <div className="bg-blue-500 text-white py-1 rounded">13</div>
                <div className="bg-blue-500 text-white py-1 rounded">14</div>
                <div className="bg-blue-500 text-white py-1 rounded">15</div>
                <div className="bg-blue-500 text-white py-1 rounded">16</div>

                {/* Week 47 */}
                <div className="bg-blue-500 text-white py-1 rounded">17</div>
                <div className="bg-blue-500 text-white py-1 rounded">18</div>
                <div className="bg-blue-500 text-white py-1 rounded">19</div>
                <div className="bg-blue-500 text-white py-1 rounded">20</div>
                <div className="bg-blue-500 text-white py-1 rounded">21</div>
                <div className="bg-blue-500 text-white py-1 rounded">22</div>
                <div className="bg-blue-500 text-white py-1 rounded">23</div>

                {/* Week 48 - End of Phase 2 */}
                <div className="bg-blue-500 text-white py-1 rounded">24</div>
                <div className="bg-blue-500 text-white py-1 rounded">25</div>
                <div className="bg-blue-500 text-white py-1 rounded">26</div>
                <div className="bg-blue-500 text-white py-1 rounded">27</div>
                <div className="bg-blue-500 text-white py-1 rounded">28</div>
                  ...
                  <div className="flex items-center justify-between mb-3">
                    {editingTeam === team.id ? (
                      <input
                        ...
                        autoFocus
                        className="font-medium text-gray-900 border-b border-gray-900 outline-none bg-transparent"
                      />
                    ) : (
                                ...
                                <td className="py-3 px-4">
                                  {editingMember === member.id ? (
                                    <input
                                      ...
                                      autoFocus
                                      className="text-sm text-gray-900 border-b border-gray-900 outline-none w-full bg-transparent"
                                    />
                                  ) : (
                                ...
                                <td className="py-3 px-4">
                                  <div className="flex items-center gap-3">
                                    <input
                                      ...
                                      className="w-16 text-center text-sm text-gray-900 bg-transparent border-0 outline-none focus:outline-none disabled:text-gray-400 disabled:cursor-not-allowed"
                                    />
                                    <div className="flex-1 bg-gray-100 h-1">
                                      <div
                                        className="bg-blue-600 h-1 transition-all"
