...
function getTeamStats(team, phase) {
  const phaseKey = getPhaseKey(phase);
  const completed = team.members.reduce(
    (sum, member) => sum + (parseInt(member.habits[phaseKey]) || 0),
    0
  );
  const total = team.members.length * MAX_PER_PHASE;
...
function getAllMembersWithTotals(teams) {
...
export default function HabitTracker() {
  ...
  const [view, setView] = useState("teams"); // "teams" | "top3" | "individual"
  ...
  useEffect(() => {
    ...
    const adminFlag = localStorage.getItem("habitTrackerAdmin");
  ...
  const handleAdminToggle = () => {
    if (isAdmin) {
      setIsAdmin(false);
      localStorage.removeItem("habitTrackerAdmin");
      return;
    }
    ...
    if (pwd === "walkingadmin") {
      setIsAdmin(true);
      localStorage.setItem("habitTrackerAdmin", "true");
    } else if (pwd) {
  ...
  const updateMemberResult = (teamId, memberId, value) => {
    if (!isAdmin) return;
    const safe = Math.min(MAX_PER_PHASE, Math.max(0, parseInt(value) || 0));
  ...
  // ----- calendar (with lighter colours & no weekends) -----
      ...
      <div className="grid grid-cols-3 gap-6">
        ...
        <div>
          <div className="flex items-center gap-2 mb-3">
            <h3 className="text-lg font-medium text-red-500/80">October</h3>
          ...
          <div className="grid grid-cols-7 gap-1 text-center text-xs">
            ...
            {/* Week 44 - Start of Phase 1 (only Mon–Fri coloured) */}
            <div className="py-1">20</div>
            <div className="bg-red-400 text-white rounded py-1 font-medium">
              21
            </div>
            <div className="bg-sky-300 text-white py-1 rounded">22</div>
            <div className="bg-sky-300 text-white py-1 rounded">23</div>
            <div className="bg-sky-300 text-white py-1 rounded">24</div>
            <div className="bg-sky-300 text-white py-1 rounded">25</div>
            <div className="py-1">26</div>

            {/* Week 45 (Mon–Fri coloured) */}
            <div className="bg-sky-300 text-white py-1 rounded">27</div>
            <div className="bg-sky-300 text-white py-1 rounded">28</div>
            <div className="bg-sky-300 text-white py-1 rounded">29</div>
            <div className="bg-sky-300 text-white py-1 rounded">30</div>
            <div className="bg-sky-300 text-white py-1 rounded">31</div>
        ...
        <div>
          <div className="flex items-center gap-2 mb-3">
            <h3 className="text-lg font-medium text-red-500/80">November</h3>
            <span className="px-2 py-1 bg-sky-300 text-sky-900 text-xs font-medium rounded">
              Phase 2
            </span>
          </div>
          ...
          <div className="grid grid-cols-7 gap-1 text-center text-xs">
            ...
            {/* Week 44–45 continuation (weekend only, not coloured) */}
            ...
            {/* Week 45 - End of Phase 1 (Mon–Fri coloured) */}
            <div className="bg-sky-300 text-white py-1 rounded">3</div>
            <div className="bg-sky-300 text-white py-1 rounded">4</div>
            <div className="bg-sky-300 text-white py-1 rounded">5</div>
            <div className="bg-sky-300 text-white py-1 rounded">6</div>
            <div className="bg-sky-300 text-white py-1 rounded">7</div>
            <div className="py-1">8</div>
            <div className="py-1">9</div>

            {/* Week 46 - Start of Phase 2 (Mon–Fri coloured) */}
        ...
        <div>
          <div className="flex items-center gap-2 mb-3">
            <h3 className="text-lg font-medium text-red-500/80">December</h3>
          ...
          <div className="grid grid-cols-7 gap-1 text-center text-xs">
            ...
            <div className="bg-indigo-400 text-white py-1 rounded">1</div>
            <div className="bg-indigo-400 text-white py-1 rounded">2</div>
            <div className="bg-indigo-400 text-white py-1 rounded">3</div>
            <div className="bg-indigo-400 text-white py-1 rounded">4</div>
            <div className="bg-indigo-400 text-white py-1 rounded">5</div>
            <div className="py-1">6</div>
            <div className="py-1">7</div>

            {/* Week 49 */}
            <div className="bg-indigo-400 text-white py-1 rounded">8</div>
            <div className="bg-indigo-400 text-white py-1 rounded">9</div>
            <div className="bg-indigo-400 text-white py-1 rounded">10</div>
            <div className="bg-indigo-400 text-white py-1 rounded">11</div>
            <div className="bg-indigo-400 text-white py-1 rounded">12</div>
            <div className="py-1">13</div>
            <div className="py-1">14</div>

            {/* Week 50 - End of Phase 3 */}
            <div className="bg-indigo-400 text-white py-1 rounded">15</div>
            <div className="bg-indigo-400 text-white py-1 rounded">16</div>
            <div className="bg-indigo-400 text-white py-1 rounded">17</div>
            <div className="bg-indigo-400 text-white py-1 rounded">18</div>
            <div className="bg-indigo-400 text-white py-1 rounded">19</div>
            <div className="py-1">20</div>
  ...
  const renderTop3 = () => (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
        {teams.map((team) => {
          const stats = getTeamStats(team, currentPhase);
          return (
            <button
              key={team.id}
              onClick={() => {
  ...
  const renderIndividualRanking = () => {
    const allMembers = getAllMembersWithTotals(teams).sort(
      (a, b) => b.total - a.total
    );
                ...
                return (
                  ...
                  >
                    ...
                    <td className="py-3 px-4 text-center">
                      <span className="text-sm text-gray-900">
                        {member.phase1}/{MAX_PER_PHASE}
                      </span>
                    </td>
                    <td className="py-3 px-4 text-center">
                      <span className="text-sm text-gray-900">
                        {member.phase2}/{MAX_PER_PHASE}
                      </span>
                    </td>
                    <td className="py-3 px-4 text-center">
                      <span className="text-sm text-gray-900">
                        {member.phase3}/{MAX_PER_PHASE}
                      </span>
                    </td>
                    <td className="py-3 px-4 text-center bg-gray-50">
                      <span className="text-sm font-semibold text-gray-900">
                        {member.total}/{MAX_PER_PHASE * PHASES.length}
                      </span>
                    </td>
                  </tr>
                );
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-7xl mx-auto">
        ...
        {view === "individual" && renderIndividualRanking()}
      </div>
    </div>
  );
}
